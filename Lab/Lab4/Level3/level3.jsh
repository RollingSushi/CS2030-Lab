...
class AlwaysTrue<T> implements BooleanCondition<T>   {public boolean test(T t) { return true; }}
class AlwaysFalse<T> implements BooleanCondition<T>   {public boolean test(T t) { return false; }}
